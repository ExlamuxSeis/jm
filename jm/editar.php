...
<body>
        ...
        <form method="post" action="actualizar.php">
            <div class="mb-3">
                ...
                <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $registros['id'] ?>">
                <input type="hidden" class="form-control" id="editados" name="editados" value="<?php echo $registros['editados'] + 1 ?>">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" required id="texto" name="texto" rows="2" > <?php echo $registros['texto']; ?></textarea>
            </div>
            <div class="mb-3">
                <label for="fecha" class="form-label">Fecha:</label>
                <input type="date" class="form-control" required value="<?php echo $registros['fecha'] ?>" id="fecha" name="fecha">
            </div>
